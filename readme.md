...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="1000" height="330">
		...
		<svg class="guage-div guage-perf guage-green" viewBox="0 0 200 200" width="200" height="200" x="0" y="0">
			...
			<circle class="gauge-arc guage-arc-1" r="56" cx="100" cy="60" stroke-width="8" style="stroke-dasharray: 351.858, 351.858;"></circle>
		...
		<svg class="guage-div guage-acc guage-green" viewBox="0 0 200 200" width="200" height="200" x="200" y="0">
			<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"></circle>
			<circle class="gauge-arc guage-arc-2" r="56" cx="100" cy="60" stroke-width="8" style="stroke-dasharray: 351.858, 351.858;"></circle>
			<text class="guage-text" x="100px" y="60px" alignment-baseline="central" dominant-baseline="central" text-anchor="middle">100</text>
		...
		<svg class="guage-div guage-best guage-orange" viewBox="0 0 200 200" width="200" height="200" x="400" y="0">
			<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"></circle>
		...
		<svg class="guage-div guage-seo guage-red" viewBox="0 0 200 200" width="200" height="200" x="600" y="0">
			<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"></circle>
		...
		<svg class="guage-div guage-pwa " viewBox="0 0 200 200" width="200" height="200" x="800" y="0">
			<svg viewBox="0 0 60 60" width="112" height="112" x="44" y="4">
				...
				<g stroke="none" fill-rule="nonzero">
					...
					<g class="lh-gauge--pwa__component lh-gauge--pwa__fast-reliable-installable-badges lh-gauge--pwa__visible">
		...
		<svg width="604" height="76" x="200" y="250">
			...
			<g>
				<rect fill-opacity="0" stroke="#616161" stroke-width="2" rx="40" id="svg_2" height="72" width="600" y="1" x="0" fill="#000000"/>
