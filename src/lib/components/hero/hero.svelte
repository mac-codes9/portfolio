...
<div class="space-y-2 max-w-lg">
  ...
  <a href="https://github.com/mac-codes9" class="button no-underline flex items-center gap-x-[2px] font-semibold bg-neutral-100 hover:bg-neutral-400 text-neutral-900">
