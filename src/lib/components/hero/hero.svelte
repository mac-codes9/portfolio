...
<div class="space-y-2 w-full max-w-lg mx-auto md:max-w-3xl md:px-4">
  ...
  <a href="https://github.com/mac-codes9" class="button no-underline flex items-center gap-x-[2px] bg-neutral-100 hover:bg-neutral-400 text-neutral-900">
